...
#define CONFIG_UNAME_RELEASE "2.6.32-24-generic"
...
#define CONFIG_CMDLINE "mem=48M root=31:04 rw rootflags=noatime rootfstype=jffs2 init=/sbin/init console=ttyS0,115200 ubi.mtd=Brio ubi.mtd=prg_Brio ubi.mtd=Cartridge ubi.mtd=EXT ubi.mtd=prg_EXT"
